...
export const PT: Record<keyof typeof EN, string> = {
  ...
  /* ---- fragmentos (shards) --------------------------------------------- */
  'shards.blurb':
    'Todas as unidades conhecidas pelo jogo, mesmo as que você ainda não desbloqueou — fragmentos já reunidos para uma delas contam. Quando a próxima promoção está atrás de uma ascensão, o custo mostrado já inclui o que a própria ascensão exige primeiro. Uma unidade ainda não desbloqueada não mostra promoção nem ascensão: nenhuma das duas se aplica antes do desbloqueio, e não temos um custo de desbloqueio confiável por unidade para mostrar em vez disso.',
  ...
  'td.normalDamage': '{n} normal',
  'td.abilityDamage': '{n} de habilidade',
  ...
  'td.campaign': 'Campanha',
  'td.side': 'Lado',
  'td.level': 'Dificuldade',
  'td.nodeLabel': 'Nó',
  ...
  'td.takeOff': 'Tirar de {unit} · {slot}',
  'td.leavesBare': 'deixa esse espaço vazio',
  'td.fromInventory': 'inventário',
  'td.wearingNothing': 'nada',
  'td.itemLevel': 'nv {n}',
  'td.slotNumber': 'espaço {n}',
  'td.clearLayout': 'Limpar',
  'td.swapNote':
    'Um movimento que tira uma peça de um companheiro esvazia o espaço dele, então o ganho ao lado é o do esquadrão inteiro, não o de quem recebe — e o que quem recebe tira volta para a pilha, para uma linha seguinte aproveitar. Um espaço que não sobrou nada para preencher fica marcado.',
  ...
  'td.nodeBlurb':
    'Nós de campanha não exigem unidades específicas, então, dentro de quem a campanha deixa você levar, este é um esquadrão escolhido para sobreviver ao nó. As colunas “neste nó” no seletor são o dano de cada unidade depois da armadura destes inimigos, e é por isso que um atacante Psíquico supera um Físico maior aqui — separado entre a arma que ele usa todo turno e a habilidade que normalmente dá um tiro só.',
  ...
  'td.nodeOnly': 'nó {node} ({slots} espaços)',
  'td.campaignNode': '{campaign} nó {node}',
